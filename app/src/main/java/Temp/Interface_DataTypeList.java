 ...
 * データ型のテンプレート一覧
 */
public interface Interface_DataTypeList {
...
//        }};
    ...
    class ParcelableClass implements Parcelable {
         ...
         */
        public static final Parcelable.Creator<ParcelableClass> CREATOR
        ...
        private static class InnerDataParacelableClass implements Parcelable {
            ...
            public static final Parcelable.Creator<InnerDataParacelableClass> CREATOR
                    = new Parcelable.Creator<InnerDataParacelableClass>() {
